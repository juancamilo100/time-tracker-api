export const envVarNames = {
    ...
    invoiceCustomerAddressLine1: 'INVOICE_CUSTOMER_ADDRESS_1',
    invoiceCustomerAddressLine2: 'INVOICE_CUSTOMER_ADDRESS_2',
    invoiceCustomerAddressLine3: 'INVOICE_CUSTOMER_ADDRESS_3',
